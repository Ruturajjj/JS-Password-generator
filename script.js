...
//fisher Yates method algorithm to shuffle
...
generateBtn.addEventListener('click', ()=>{
    ...
    //compulsory addition or syllables
    for(let i=0;i<funcArr.length;i++){
        password += funcArr[i]();
    }

    //remaining syllables(means 10 is password 2 is ticked then other 8 is remaining)
